...
class CryptoAPITrading:
    def __init__(self, secrets_file):
        ...
        self.api_key = keys["Robinhood"]["Api"]
        private_key_seed = base64.b64decode(keys["Robinhood"]["Private"])
...
def main():
    api_trading_client = CryptoAPITrading(secrets_file="../../../keys/secrets.json")
